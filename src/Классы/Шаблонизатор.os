...
Функция Форма(ИмяФормы, Обработчик = Неопределено)

	ШаблонАтрибутов = "<form name=""%1"" id=""%1"" action=""%2"" method=""POST"">
	...
	Возврат СтрШаблон(ШаблонАтрибутов, ИмяФормыЛатиница, ПутьКОбработчику, ИмяФормыЛатиница);
...
Функция АтрибутыПоляФормы(ПутьКДанным)
	
	ШаблонАтрибутов = "name=""%1"" id=""%2"" value=""%3""";
	...
	Возврат СтрШаблон(ШаблонАтрибутов, ИмяПоляЛатиница, ИмяПоляЛатиница, ПолеФормы.Значение());
