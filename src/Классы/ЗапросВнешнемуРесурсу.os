...
Процедура ПриСозданииОбъекта(Метод, Сервер, ЗащищенноеСоединение = Ложь, Порт = Неопределено, ТаймаутСоединения = 0)
...
Процедура УстановитьТело(ТипКонтента, ДанныеТела) Экспорт
	...
	ЗаголовкиЗапроса.Вставить("Content-Type", ОбслуживаниеWebСервера.ОпределитьТипСодержимого(ТипКонтента));
