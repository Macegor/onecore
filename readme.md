...
Перед установкой у вас уже должна быть установлена платформа onescript версией не менее 2.0RC4.
...
```bsl
Процедура ПередВыполнениемПредставления(Запрос, Ответ, ПродолжитьОбработку) Экспорт
...
Процедура ПослеВыполненияПредставления(Запрос, Ответ, ПродолжитьОбработку) Экспорт
