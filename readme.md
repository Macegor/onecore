...
```bsl
Процедура ПередВыполнениемПредставления(Запрос, Ответ) Экспорт
...
Процедура ПослеВыполненияПредставления(Запрос, Ответ) Экспорт
